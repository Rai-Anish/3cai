...
export function ChatShell({
  ...
  return (
    <section className="flex h-full flex-col overflow-hidden rounded-3xl border border-border/40 bg-background">

      {/* ── Header ── */}
      <div className="relative shrink-0 overflow-hidden border-b border-border/30">
        ...
        <div className="relative px-6 py-5 sm:px-8 sm:py-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-border/40 bg-background/80 px-3 py-1 text-xs text-muted-foreground backdrop-blur">
      ...
      <div className="min-h-0 flex-1 overflow-hidden">
        {!hasMessages ? (
          <div className="chat-scroll h-full overflow-y-auto">
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                {prompts.map((prompt) => (
                  <button
                    ...
                    className="rounded-full border border-border/40 bg-background px-4 py-2 text-sm text-foreground transition-colors hover:border-primary/40 hover:text-primary"
                  >
                    {prompt}
                  </button>
                ))}
            ...
            {/* Topics */}
            <div className="grid gap-3 border-b border-border/30 px-6 py-4 md:grid-cols-3">
            ...
            <div className="flex items-center justify-center px-6 py-8">
              <div className="w-full max-w-2xl rounded-3xl border border-dashed border-border/50 bg-muted/20 px-8 py-12 text-center">
