...
import { FaTwitter, FaLinkedin, FaInstagram, FaDiscord, FaGithub } from "react-icons/fa";
        ...
        <div className="grid grid-cols-2 lg:grid-cols-5 gap-y-12 md:gap-y-16 gap-x-8 mb-16 pt-8">
          ...
          <div className="col-span-2 lg:col-span-2 flex flex-col gap-8">
            ...
            <div className="flex gap-4">
              {[
                { icon: FaTwitter, href: "https://x.com/3cai_company" },
                { icon: FaGithub, href: "https://github.com/Rai-Anish/3cai" },
                { icon: FaLinkedin, href: "https://www.linkedin.com/in/anishrai3737/" }
              ].map((social, i) => (
                <Link
                  key={i}
                  href={social.href}
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link href="/products/resume" className="text-muted-foreground hover:text-white transition-colors text-sm font-medium">Resume Analyzer</Link>
            <Link href="/products/interviews" className="text-muted-foreground hover:text-white transition-colors text-sm font-medium">Mock Interviews</Link>
            <Link href="/products/roadmap" className="text-muted-foreground hover:text-white transition-colors text-sm font-medium">Career Roadmap</Link>
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link target="_blank" rel="noopener noreferrer" href="/https://medium.com/@anish.rai3737" className="text-muted-foreground hover:text-white transition-colors text-sm font-medium">Blog</Link>
